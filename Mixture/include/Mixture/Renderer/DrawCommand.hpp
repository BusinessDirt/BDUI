...
namespace Mixture
{
	...
	public:
		...
		static void DrawIndirect(VkCommandBuffer commandBuffer, const Vulkan::Buffer& buffer, VkDeviceSize offset);
		static void DrawIndexedIndirect(VkCommandBuffer commandBuffer, const Vulkan::Buffer& buffer, VkDeviceSize offset);
	};
}
