...
namespace Mixture::Vulkan
{
    ...
    void Context::EndRenderpass(const VkCommandBuffer commandBuffer) const
    {
    ...
    {
        if (const VkResult result = m_Swapchain->SubmitCommandBuffers(commandBuffers);
    ...
    void Context::RebuildSwapchain()
    {
        ...
        Get().m_Swapchain = CreateScope<class Swapchain>(oldSwapchain);
